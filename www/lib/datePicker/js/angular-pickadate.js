          ...
          '<div class="pickadate">' +
            '<div class="pickadate-header">' +
              '<div class="pickadate-controls">' +
                '<a href="" class="pickadate-prev ion-ios-arrow-left" ng-click="changeMonth(-1)" ng-show="allowPrevMonth"></a>' +
                '<a href="" class="pickadate-next ion-ios-arrow-right" ng-click="changeMonth(1)" ng-show="allowNextMonth"></a>' +
              '</div>'+
